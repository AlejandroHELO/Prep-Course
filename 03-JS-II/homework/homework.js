...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num3 > num1 && num3 > num2) {
    num3++
    return num3
  } // se puede así o solo copiando return ++num3 para aumentar el valor antes de retornarlo
  return false
  //recordar la presedencia de operadores
}
...
function tablaDelSeis() {
  ...
  //Escribe tu código aquí   
  var arraytablatabladelseis = []
  for (var x = 0; x < 11; x++) {
    arraytablatabladelseis.push(6 * x)
  }
  return arraytablatabladelseis
}
