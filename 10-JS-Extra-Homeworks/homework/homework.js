...
function capicua(numero){
  ...
  //numero = 150, toString para volverlo "150", split para volverlo 1 5 0, reverse para volverlo 0 5 1, join para unirlo de nuevo
  alreves = parseInt(alreves);
  //        con este metodo se vuelve a pasar de string a número "150" = 150
  if (numero === alreves){
    return "Es capicua"
  }
